...
typedef void* ordenar (void* elemento1,void* elemento2);//tipo padrão de função de ordenação

Lista *criarLista();//funcao que cria a lista
void inserirElemento(Lista* li,void* dado);//funcao que cria um novo nó na lista
void inserirElementoOrdenado(Lista* li,void* dado,void * funcDeOrdenacao);//funcao que insere um novo nó na lista de forma ordenada
void removerElementoInicio(Lista* li,int _FREE_DATA_);//remove o último nó adicionado na lista
void inserirElementoFinal(Lista* li,void* dado);// cria um elemento após o ultimo nó
